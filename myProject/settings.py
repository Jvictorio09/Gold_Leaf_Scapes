...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-xp(#0mb@kw=5n9_*8i@ltih$6w82b7k6)1+zd9zp+l%@=$^2r7')
...
INSTALLED_APPS = [
    ...
    'myApp.apps.MyappConfig',  # Use app config to register signals
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'myApp.context_processors.footer_services',
            ],
        },
    },
]
